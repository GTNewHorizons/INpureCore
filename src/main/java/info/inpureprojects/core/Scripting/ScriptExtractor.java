...
public class ScriptExtractor implements IINpureSubmodule {
    ...
    private final String[] files = new String[] { "AppliedEnergistics2.js", "Bibliocraft.js", "Bootstrap.js",
            "BuildCraft.js", "ExtraUtilities.js", "ForgeMicroblock.js", "Mekanism.js", "nei_filters.toc",
            "ThermalExpansion.js", "vanilla.js", "Tcon.js", "MFR.js" };
            ...
            for (String s : this.files) {
                INpureCore.proxy.print(
                        "Extracting: " + s
                                ...
                                + s
                                + ".");
                Reader r = Streams.instance
                        .getReader(getClass().getClassLoader().getResourceAsStream("scripts/custom_nei_filters/" + s));
